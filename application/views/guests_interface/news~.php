	...
	<div class="wrapper">
		...
		<div id="main" class="catalog-item-list-container">
			<div class="catalog_seo">
				<h1>Каталог итальянской мебели салона «Arredamenti»</h1>
				<div class="fotorama news-fotorama">
					<img src="http://arredamenti.su/img/fotorama/4.jpg" alt="">
					<img src="http://arredamenti.su/img/fotorama/3.jpg" alt="">
				</div>
				<div>
	  				Салон «Arredamenti» – это элитная итальянская мебель в Ростове-на-Дону. Вы можете у нас купить итальянскую мебель от 102 производителей. На нашем сайте каталог мебели позволит выбрать не только гарнитур в кухню, детскую комнату, кабинет или офис, но и подобрать диван, наиболее подходящий интерьерному дизайну в вашем доме или офисе. Каталог итальянской мебели салона «Arredamenti» поможет выбрать любой предмет мебели, чтобы он идеально вписался в концепцию интерьерного решения дома или офиса. Итальянская мебель в Ростове – это салон «Arredamenti». Итальянская мебель, представленная в нашем салоне, эстетична, изготовлена из высококачественного материала по европейским стандартам качества.
				</div>
