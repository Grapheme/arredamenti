...
<link href="<?=site_url('css/admin-panel/redactor.css');?>" rel="stylesheet" />
</head>
<body>
<!--[if lt IE 7]>
		...
		<div class="row">
			...
			<div class="span9">
				<ul class="breadcrumb">
					...
					<li><a href="<?=site_url(ADMIN_START_PAGE.'/news?mode=list');?>">Новости</a> <span class="divider">/</span></li>
					<li class="active">Редактирование новости</li>
				</ul>
				<div class="clear"></div>
				<?php $this->load->view('admin_interface/forms/edit-news');?>
			</div>
		</div>
	</div>
...
<script type="text/javascript" src="<?=site_url('js/libs/redactor-config.js');?>"></script>
