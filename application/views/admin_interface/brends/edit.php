		...
		<div class="row">
			...
			<div class="span9">
				<ul class="breadcrumb">
					...
					<li><a href="<?=site_url(ADMIN_START_PAGE.'/brends?mode=list');?>">Фабрики (бренды)</a> <span class="divider">/</span></li>
					<li class="active">Редактирование фабрики</li>
				</ul>
				<div class="clear"></div>
				<?php $this->load->view('admin_interface/forms/edit-brend');?>
			</div>
		</div>
	</div>
