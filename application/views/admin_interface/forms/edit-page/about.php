<?=form_open(ADMIN_START_PAGE.'/page/update?mode=update&id='.$this->input->get('id'),array('class'=>'form-manage-page')); ?>
	...
	<hr/>
		...
		<textarea class="redactor" rows="10" name="content[ru_content]"><?=(isset($contentData['ru_content']))?$contentData['ru_content']:'';?></textarea>
		<label>Контент (EN):</label>
		<textarea class="redactor" rows="10" name="content[en_content]"><?=(isset($contentData['en_content']))?$contentData['en_content']:'';?></textarea>
	<hr/>
